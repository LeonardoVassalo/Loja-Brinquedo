...
<body>
	...
	<div class="wrapper">
		...
		<div class="main_content">
			<div class="header">
				<center>ADMINISTRAÇÃO DE BRINQUEDOS</center>
			</div>
		<br>

			<center><td><form action="jsp/incluir.jsp" method="post"
									style="display: inline;">
									<button class="btnn" type="submit"
										name="txtId" value="">
										<i class="bi bi-pencil-square"></i> Cadastrar Novos Brinquedos
									</button>
								</form>    </td></center>
								<br>
			...
			<div class="col-md-4">
				<table style="width: 80vw;" class="table">
					...
					<tbody>
						<tr>
							<th><%=a.getIdBrinquedo()%></th>
							<td><img src=<%="Imagens/" + a.getImagem()%>
								style="width: 60px;"></td>
							<td><%=a.getNome()%></td>
							<td><%=a.getCategoria()%></td>
							<td><%=a.getMarca()%></td>
							<td><%=a.getValor()%></td>
							<td><form action="ServletBrinquedo?cmd=atu" method="post"
									style="display: inline;">
									<button class="btnn" type="submit"
										name="txtId" value="<%=a.getIdBrinquedo()%>">
								...
								<form action="ServletBrinquedo?cmd=excluir" method="post"
									...
									data-toggle="modal" data-target="#modalExemplo<%=a.getIdBrinquedo()%>">
									
										<i class="bi bi-pencil-square"></i> Excluir
									</button>

									<div class="modal fade" id="modalExemplo<%=a.getIdBrinquedo()%>" tabindex="-1"
										role="dialog" aria-labelledby="exampleModalLabel<%=a.getIdBrinquedo()%>"
										aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="exampleModalLabel<%=a.getIdBrinquedo()%>">Confirmar Exclusão</h5>
													<button type="button" class="close" data-dismiss="modal"
														aria-label="Fechar">
														<span aria-hidden="true">&times;</span>
													</button>
												</div>
												<div class="modal-body">Você realmene deseja excluir esse Brinquedo ?</div>
